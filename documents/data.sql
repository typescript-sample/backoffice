...
insert into modules (moduleid,modulename,status,path,resourcekey,icon,sequence,actions,parent) values ('user','User Management','A','/admin/users','user','person',1,7,'admin');
insert into modules (moduleid,modulename,status,path,resourcekey,icon,sequence,actions,parent) values ('role','Role Management','A','/admin/roles','role','credit_card',2,7,'admin');
insert into modules (moduleid,modulename,status,path,resourcekey,icon,sequence,actions,parent) values ('audit_log','Audit Log','A','/admin/audit-logs','audit_log','zoom_in',4,1,'admin');
